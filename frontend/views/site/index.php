...
<ul class="bxslider">
    <div class="bxslider_main">
        <li><img class="item" src="/frontend/web/pictures/image1.png">
        ...
        <li><img class="item" src="/frontend/web/pictures/image2.png">
        ...
        <li><img class="item" src="/frontend/web/pictures/image3.png">
...
<div class="content">
    <div class="content_layout">
        <div class="icon_mainpage"><a href="<?= Url::toRoute(['page/village']) ?>">
                <div class="box_icon_picture"><img class="pictire_icon" src="/frontend/web/pictures/icon_localization.png"></div>
        ...
        <div class="icon_mainpage">
            <a href="<?= Url::toRoute(['selection/selection']) ?>">
                <div class="box_icon_picture"><img class="pictire_icon" src="/frontend/web/pictures/icon_home.png"></div>
                <div class="box_text_icon">
        ...
        <div class="icon_mainpage">
            <a href="<?= Url::toRoute(['page/how_buy']) ?>">
                <div class="box_icon_picture"><img class="pictire_icon" src="/frontend/web/pictures/icon_wallet.png"></div>
                <div class="box_text_icon">
    ...
    <div class="sidebar">
        <div class="bxslider bxslider2">
            <div class="slider_right">
                ...
                <div><a href="#"><img class="item" src="/frontend/web/pictures/sale3.png"></a>
                </div>

                <div><a href="#"><img class="item" src="/frontend/web/pictures/sale4.png"></a>
                </div>

                <div><a href="#"><img class="item" src="/frontend/web/pictures/sale5.png"></a>
                </div>

                <div><a href="#"><img class="item" src="/frontend/web/pictures/sale6.png"></a>
                </div>

                <div><a href="#"><img class="item" src="/frontend/web/pictures/sale7.png"></a>
                </div>

                <div><a href="#"><img class="item" src="/frontend/web/pictures/sale8.png"></a>
                </div>

                <div><a href="#"><img class="item" src="/frontend/web/pictures/sale9.png"></a>
                </div>
            </div>
        </div>
