			...
			<div class="resp-tabs-container hor_1">
				...
				<div class="fourth_tab">
					...
					<div class="text_fourth_tab">
						...
						<ul>
							<li>
								Форма участка. Самой выгодной для застройки считается квадратная, однако популярностью
								пользуются и прямоугольные участки,
								в особенности если речь идет о возведении частного дома и создании сада или огорода
								рядом. Кроме того, встречаются также участки с
								Г-образной структурой, но их приобретают реже. Если у вас есть план расположения
								построек и всего, что будет находиться на вашей
								будущей земле, и он предусматривает самое эффективное размещение именно на участке такой
								формы, то есть смысл поискать такой вариант.
								Если же вы планируете обычное строительство дома с пристройками, то с участками
								Г-образной формы лучше не связываться.
							</li>
							<li>
								Тип грунта на участке. Следует заранее проверить это, поскольку не каждый грунт подходит
								для закладки фундамента, а ряд типов
								вообще позволяет установить дом, к примеру, только на винтовых сваях.
								Также важно проверить, насколько глубоко залегают грунтовые воды: близкое расположение к
								поверхности негативно скажется на постройке.
							</li>
							<li>
								Коммуникации. Сюда входит обеспечение участка электричеством, водой, наличие или
								отсутствие отопления, канализации.
								Если вам не хочется возиться с подключением за свой счет или искать способы
								альтернативного энергообеспечения, то следует
								выбирать участок, к которому подведены электрические сети напрямую либо находятся в
								непосредственной близости от него, так чтобы можно
								было подключиться к подстанции. Конечно, участки, к которым не подведено электричество,
								стоят обычно дешевле, но покупка выгодной не
								окажется: подключение своими силами займет либо очень много времени, либо обойдется в
								несколько раз дороже. Водоснабжение, если оно не
								имеет централизованного подключения, можно оборудовать скважинным методом. Отопление
								может быть газовым или электрическим: как правило
								, такой вид можно встретить чаще всего. Что касается канализации, то, если она не
								оборудована централизованным методом, нужно
								устраивать ее самостоятельно в виде септика. При этом немаловажно сразу уточнять,
								разрешено ли это на участке,
								поскольку в ряде случаев это невозможно из-за близости к водоемам, охранным зонам,
								экологически охраняемым районам и т. д.
							</li>
							<li>
								Инфраструктура местности, в которой расположен поселок. К ней относится транспортное
								сообщение, близость к трассам, удобство подъездов
								как к местности, так и самому участку. Важно сразу уточнить, есть ли общественный
								транспорт в самом населенном пункте, к которому
								относится участок, есть ли транспортная связь с другими городами или поселками,
								насколько удобно доехать до участка от того места,
								где вы проживаете на постоянной основе. Кроме того, к инфраструктуре относятся такие
								объекты, как магазины, аптеки, больницы, школы и
								детские сады, почта, банк. Их наличие влияет на стоимость участка, поэтому, если вам, к
								примеру, не хочется, чтобы рядом находиласьшкола,
								то лучше выбрать участок в отдалении, так чтобы он находился неподалеку от других
								объектов, необходимых для комфортного проживания.
							</li>
							<li>
								Расположение участка относительно природных ресурсов: леса, воды. Если участок находится
								рядом с водоемом, следует проверить,
								насколько удобны подступы к нему, не сливают ли в водоем промышленные отходы.
								Это также важно проверять для того, чтобы установить возможность оборудования локальной
								канализации.
							</li>
							<li>
								Расположение относительно других участков. При выборе нужно обращать внимание, насколько
								они удалены от вашего будущего участка,
								не падает ли излишняя тень от соседних строений или деревьев. Также стоит посмотреть, в
								каком положении находится участок:
								на возвышении, на наклонной плоскости, в нижней части рельефа. От этого будет зависеть
								степень затопления участка в весеннее время
								от таяния снега: лучше брать землю на возвышении или ровной поверхности. Кроме того,
								важно, чтобы земли соседей не находились над
								вашим участком:
