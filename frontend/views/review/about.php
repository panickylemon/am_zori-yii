		...
		<div class="content_layout_village">
			...
			<div class="about_page">
				...
				<div class="right_box_about">
					...
					<div class="right_box_about_text">Компания "Амурские зори" занимается продажей земельных участков в
			...
			<div class="about_page">
				...
				<div class="right_box_about responsive_second_right">
					...
					<div class="about_icon_responsive">
			...
			<div class="about_page">
				...
				<div class="right_box_about">
					...
					<div class="right_box_about_text">В компании "Амурские зори" работают квалифицированные, опытные
						специалисты.
					...
					<div class="right_box_about_text">Лидером и идейным вдохновителем нашей команды является генеральный
						директор компании
			...
			<div class="about_page">
				...
				<div class="right_box_about">
					...
					<div class="reviews">
						...
						<div class="review_view_all"><?= Html::a('Смотреть все отзывы', ['review/review']) ?></div>
					</div>
				</div>
